...
app.get('/', (req, res) => {
  res.send('Go to <a href="/events?eps=10">/events?eps=10</a> for the event source stream. Change the eps querystring param to vary the simulated events per second.')
})
