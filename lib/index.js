...
app.get('/', (req, res) => {
  res.send('<a href="http://synthetic-usa.robscanlon.com/?eps=10">demo vis</a>.<br><BR>Go to <a href="/events?eps=10">view raw stream</a>. <br><br>Change the eps querystring param to vary the simulated events per second.')
})
